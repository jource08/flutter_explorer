  ...
  final Folder rootFolder = Folder(
    ...
    subFolders: [
      Folder(
        ...
        subFolders: [
          Folder(id: '3', name: 'Projects', createdAt: DateTime.now(), icon: 'work', isHidden: false),
        ],
        files: [File(id: '101', name: 'Resume', type: 'pdf', size: 12345, folderId: '2', createdAt: DateTime.now(), isHidden: false)],
      ),
      Folder(
        id: '4',
        name: 'Pictures',
        createdAt: DateTime.now(),
        files: [File(id: '102', name: 'Vacation', type: 'jpg', size: 56789, folderId: '4', createdAt: DateTime.now(), isHidden: false)],
      ),
    ],
  );

  FolderProvider() {
    _selectedFolder = rootFolder;  // Start with root folder
  }
